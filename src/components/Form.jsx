...
function FormItems() {
  ...
  const formItems = [
    ...
    { label: 'Email:', type: 'email', id: 'email', placeHolder: 'trevorlawrence@jags.com' },
  ...
  return (
    <>
        ...
        <form className='form' onSubmit={validateForm} noValidate>
          {formItems.map(({ label, type, id, placeHolder }) => (
            <div key={id} className='form-item'>
              ...
              <input type={type} id={id} name={id} className='form-input' placeholder={placeHolder} />
            </div>
          ))}
      ...
      <div className={`thank-you-container ${isSubmitted ? '' : 'hidden'}`}>
        <span className='thanks-text'>Thank you! We will reach out shortly.</span>
